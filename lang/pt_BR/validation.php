...
return [
    ...
    'insufficient_funds'     => 'A conta não possui saldo suficiente para esta transferência.',
    'account_not_found'      => 'O número da conta especificado não existe.',
    'unique_account_number'  => 'O número da conta já está em uso.',
];
